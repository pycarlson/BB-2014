...
# DropLocation.create!(:drive_id => Drive.last.id, :name => 'Richmond', :street => ' 2727 Macdonald Ave', :city => 'Richmond', :state => 'CA', :zipcode => '94804')
# DropLocation.create!(:drive_id => Drive.last.id, :name => 'Oakland', :street => '2648 International Blvd', :city => 'Oakland', :state => 'CA', :zipcode => '94601')
# DropLocation.create!(:drive_id => Drive.last.id, :name => 'Antioch', :street => '512 W 5th St', :city => 'Antioch', :state => 'CA', :zipcode => '94509')
