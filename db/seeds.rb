...
Family.create!(code: 'famBam', drive_id: Drive.last.id, drop_location_id: Drive.last.drop_locations.first.id)
1.upto(1+rand(10)) do
  FamilyMember.create!(:family_id => Family.last.id, :gender => 'f', :size_pants => '4', :size_shirt => '5', :size_dress => 'm', :size_shoes => '2', :bio => 'this is a family member', :age => (1 + rand(30)))
end

Family.create!(code: 'numna', drive_id: Drive.last.id, drop_location_id: Drive.last.drop_locations.first.id)
1.upto(1+rand(10)) do
  FamilyMember.create!(:family_id => Family.last.id, :gender => 'f', :size_pants => '4', :size_shirt => '5', :size_dress => 'm', :size_shoes => '2', :bio => 'this is a family member', :age => (1 + rand(30)))
end

Family.create!(code: 'blada', drive_id: Drive.last.id, drop_location_id: Drive.last.drop_locations.first.id)
1.upto(1+rand(10)) do
  FamilyMember.create!(:family_id => Family.last.id, :gender => 'f', :size_pants => '4', :size_shirt => '5', :size_dress => 'm', :size_shoes => '2', :bio => 'this is a family member', :age => (1 + rand(30)))
end

Family.create!(code: 'hurra', drive_id: Drive.last.id, drop_location_id: Drive.last.drop_locations.last.id)
1.upto(1+rand(10)) do
  FamilyMember.create!(:family_id => Family.last.id, :gender => 'f', :size_pants => '4', :size_shirt => '5', :size_dress => 'm', :size_shoes => '2', :bio => 'this is a family member', :age => (1 + rand(30)))
end

Family.create!(code: 'lala', drive_id: Drive.last.id, drop_location_id: Drive.last.drop_locations.last.id)
1.upto(1+rand(10)) do
  FamilyMember.create!(:family_id => Family.last.id, :gender => 'f', :size_pants => '4', :size_shirt => '5', :size_dress => 'm', :size_shoes => '2', :bio => 'this is a family member', :age => (1 + rand(30)))
end

Family.create!(code: 'stata', drive_id: Drive.last.id, drop_location_id: Drive.last.drop_locations.last.id)
1.upto(1+rand(10)) do
  FamilyMember.create!(:family_id => Family.last.id, :gender => 'f', :size_pants => '4', :size_shirt => '5', :size_dress => 'm', :size_shoes => '2', :bio => 'this is a family member', :age => (1 + rand(30)))
end
